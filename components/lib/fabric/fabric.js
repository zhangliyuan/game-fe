...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
  ...
  onKeyDown: function(e) {
    //console.log(this.isEditing, e.keyCode);
    if (!this.isEditing) {
      return;
    }
    if (e.keyCode in this._keysMap) {
      //console.log(this._keysMap[e.keyCode]);
  ...
  onInput: function(e) {
    ...
    var offset = this.selectionStart || 0;
        var offsetEnd = this.selectionEnd || 0;
        var textLength = this.text.length;
        var newTextLength = this.hiddenTextarea.value.length;
        var diff = newTextLength - textLength + offsetEnd - offset;
        var charsToInsert = this.hiddenTextarea.value.slice(offset, offset + diff);
    var strCache=this.hiddenTextarea.value;
    //this._removeCharsFromTo(0, this.hiddenTextarea.value.length);
    ...
    //var tarEnd=this.hiddenTextarea.value.length-this.selectionStart;
    //console.log("start:",this.selectionStart,"end:",this.selectionEnd,"length:",this.hiddenTextarea.value.length,"tar:",tarEnd);
    //console.log("start:",this.hiddenTextarea.selectionStart,"end:",this.hiddenTextarea.selectionEnd,"length:",this.hiddenTextarea.value.length,"tar:",tarEnd);
    //this.selectionStart=1;
    //this.selectionEnd=1;
    //this.moveCursorRight(e);
    //this.selectionStart+=1;
    //this.selectionEnd+=1;
    //this.selectionEnd=this.hiddenTextarea.value-1;
    this.canvas && this.canvas.renderAll();
    this.setCoords();
    this.fire('changed');
    this.canvas && this.canvas.fire('text:changed', { target: this });
    //this.insertChar(strCache);
    e.stopPropagation();
  },

...
string.filterFormat = filterFormat;
...
var print = function( string ) {
    ...
    return ('' || string).replace(/%s/g, function( a ) {
        return undefined != argv[ index++ ] ? argv[ index-1 ] : a;
    });
}
string.print = print;
...
string.toHalfWidth = toHalfWidth;

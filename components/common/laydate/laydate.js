var a = window;
    ...
    c.use = function(a, b) {
        ...
        f.type = "text/css",
        f.rel = "stylesheet",
        f.href = '/components/common/laydate/laydate.css',
        b && (f.id = b),
    ...
    c.events = function() {
        ...
        c.on(h.oclear, "click", function() {
            c.elem[h.elemv] = "",
            c.close();
            if (c.options.clearCallback ) {
                c.options.clearCallback.call(c, c.options);
            }
        }),
